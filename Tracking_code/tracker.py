...
# 从 deep_sort.linear_assignment 导入 matching_cascade 和 gate_cost_matrix
from deep_sort.linear_assignment import matching_cascade, min_cost_matching, gate_cost_matrix
...
class Tracker:
    ...
    def _match(self, detections):
        ...
        def gated_metric(tracks, dets, track_indices, detection_indices):
            ...
            # 调用 gate_cost_matrix 而不是 linear_assignment.gate_cost_matrix
