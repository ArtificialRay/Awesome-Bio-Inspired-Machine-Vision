...
#Focal loss/如果要使用focal，就把注释去掉
#class Focal_Loss(nn.Module):
#    def __init__(self, pos_weight=1, gamma=1, reduction='mean'):
...
#
#        loss = - self.pos_weight * target * (1-logits)**self.gamma * torch.log(logits) - \
...
#       self.focal_loss = Focal_Loss() #focal loss
...
#            losses['loss_action_cls'] = loss(cls_score, labels)
